...
class MainWindow:
    def __init__(self, parent):
        ...
        # Main Content Area      
        frame_main = Frame(self.parent ,bg="#ffcc00", padx=0, pady=0)
        frame_main.grid(row=1, column=0, sticky=N+E+W+S)

        bg_image = PhotoImage(file ="bg_content.png")
        frame_bg = Label(frame_main,image = bg_image, padx=10, pady=5)

        # Content Frames

        f1 = Frame(frame_bg, bg="#ffcc00", padx=0, pady=5)
        f2 = Frame(frame_bg, bg="#ffcc00", padx=0, pady=5)
        f3 = Frame(frame_bg, bg="#ffcc00", padx=0, pady=5)
